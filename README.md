...
- [koala-ts/framework](https://github.com/koala-ts/framework) ([2.5.0](https://github.com/koala-ts/framework/releases/tag/2.5.0), 1 day ago) - KoalaTs is crafted for the laziest backend developers because nothing pairs better with clean APIs than a good nap.
- [openkairos/aletheia](https://github.com/openkairos/aletheia) ([0.0.1](https://github.com/openkairos/aletheia/releases/tag/0.0.1), 2 days ago) - A visual interface for Kairos that reveals customer insights through clean analytics and intuitive dashboards.
