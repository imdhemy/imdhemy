...
- [koala-ts/framework](https://github.com/koala-ts/framework) ([2.28.8](https://github.com/koala-ts/framework/releases/tag/2.28.8), today) - KoalaTs is crafted for the laziest backend developers because nothing pairs better with clean APIs than a good nap.
